...
def transform_fn_inner(none_model, data, input_content_type, output_content_type):
    ...
    hw_data = {"bucket": loc_out["result"]["bucket_name"], "file_name": loc_out["result"]["hw_key"], "model": hw_endpoint_model}
    hp_data = {"bucket": loc_out["result"]["bucket_name"], "file_name": loc_out["result"]["hp_key"], "model": hp_endpoint_model}
